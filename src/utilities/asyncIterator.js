...
export function toAsyncIterator(result) {
  ...
  if ((!Array.isArray(result)) &&
    ...
    return asyncIteratorForObject(result);
  }
...
/**
 * This function transforms a JS object `ObjMap<AsyncIterable<T>>` into
 * a `AsyncIterable<ObjMap<T>>`
 *
...
export function asyncIteratorForObject<T>(
  object: ObjMap<AsyncIterable<T> | T>
): AsyncIterable<ObjMap<T>> {
